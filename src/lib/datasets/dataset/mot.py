...
from lib.datasets.dataset.jde import letterbox, random_affine
...
class MOTDataset(VisionDataset):
    ...
    def __getitem__(self, index):
        ...
        labels[labels[:, 1] > -1, 1] += (self.seq_start_id[seq_name] - 1)
...
if __name__ == '__main__':
    ...
    opt = opts().parse(args={'mot'})
    dataset = MOTDataset(opt, '/home/houyz/Data/MOT17/train', augment=True, transforms=T.ToTensor())
